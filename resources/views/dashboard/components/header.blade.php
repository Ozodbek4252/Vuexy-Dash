            ...
            <li class="nav-item dropdown dropdown-language">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
                    @foreach ($langsForHeader as $headerLang)
                        <a class="dropdown-item" href="{{ route('dash.lang.change', $headerLang->id) }}"
                            data-language="{{ $headerLang->code }}">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#"
                    ...
                    <div class="user-nav d-sm-flex d-none">
                        <span class="user-name fw-bolder">{{ $user_auth->name }}</span>
                        <span class="user-status">{{ isset($user_auth->role->translations['title']['content']) ? $user_auth->role->translations['title']['content'] : ''}}</span>
                    </div>
                    <span class="avatar"
                        @if (!$user_auth->image) style="background-color: white !important;" @endif>
                        <img class="round" src="{{ $user_auth->image }}" alt="avatar" height="40"
                            width="40">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" id="logoutId">
